...
namespace EgorLin.UIWidgets.Essentials.Tutorial.Editor {
    ...
    public class TutorialDataEditor : UnityEditor.Editor {
        ...
        public override VisualElement CreateInspectorGUI() {
...

            {
                ...
                this.conditions.drawElementCallback = (rect, index, active, focused) => {
                    ...
                    rect.height = 20f;
                    var attr = new SearchComponentsByTypePopupAttribute(typeof(ICondition));
                    var prop = items.GetArrayElementAtIndex(index);
            ...
            
            {
                ...
                this.actions.drawElementCallback = (rect, index, active, focused) => {
                    ...
                    rect.height = 20f;
                    var attr = new SearchComponentsByTypePopupAttribute(typeof(IAction));
                    var prop = items.GetArrayElementAtIndex(index);
