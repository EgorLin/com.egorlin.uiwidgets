...
using EgorLin.UIWidgets.Essentials.Console.Runtime.Windows.Console;
using EgorLin.UIWidgets.Essentials.Console.Runtime.Windows.UIConsole;
using UnityEngine;

namespace EgorLin.UIWidgets.Essentials.Console.Runtime {
    ...
    public class ConsolePopup {
        ...
        public UnityEngine.UIElements.Button AddButton(string label, System.Action callback) {
            
            var element = new UnityEngine.UIElements.Button(callback);
            element.text = label;
        ...
        public UnityEngine.UIElements.Label AddLabel(string label) {

            var element = new UnityEngine.UIElements.Label(label);
            this.root.Add(element);
            return element;

        }

        public UnityEngine.UIElements.Slider AddSlider(string label, float from, float to, UnityEngine.UIElements.SliderDirection direction = UnityEngine.UIElements.SliderDirection.Horizontal, System.Action<float> onChanged = null) {
            
            var element = new UnityEngine.UIElements.Slider(label, from, to, direction);
        ...
        public UnityEngine.UIElements.SliderInt AddSliderInt(string label, int from, int to, UnityEngine.UIElements.SliderDirection direction = UnityEngine.UIElements.SliderDirection.Horizontal, System.Action<int> onChanged = null) {
            
            var element = new UnityEngine.UIElements.SliderInt(label, from, to, direction);
        ...
        public UnityEngine.UIElements.TextField AddTextField(string label, string value, bool multiline = false, int maxLength = 0, System.Action<string> onChanged = null) {

            var element = new UnityEngine.UIElements.TextField(label, maxLength, multiline, false, '*');
            element.value = value;
                ...
                if (isActive == true) {
                    ...
                    if (this.drawType == ConsoleDrawType.DefaultScreen) {
                        ...
                        if (this.consoleWindowInstance == null) {
                            ...
                            this.consoleWindowInstance = WindowSystem.ShowSync<ConsoleScreen>(x => {
                        ...
                        if (this.consoleWindowInstance == null) {
                            ...
                            this.consoleWindowInstance = WindowSystem.ShowSync<UIConsoleScreen>(x => {
