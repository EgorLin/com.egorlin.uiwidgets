...
using EgorLin.UIWidgets.Modules.Audio;
using EgorLin.UIWidgets.Pools;
using EgorLin.UIWidgets.Utilities;
using UnityEngine;
using UnityEngine.UI;

namespace EgorLin.UIWidgets.Core.Base {
    ...
    public abstract class WindowObject : MonoBehaviour, IOnPoolGet, IOnPoolAdd, ISearchComponentByTypeSingleEditor, IHolder, System.IEquatable<WindowObject> {
        ...
        public struct AnimationParametersContainer {
            ...
            [SearchComponentsByTypePopup(typeof(AnimationParameters), menuName: "Animations", singleOnly: true)]
        ...
        public void SetState(ObjectState state) {
            ...
            ComponentsDebugLog.Add(this, state);
        ...
        public void AddEditorParametersRegistry(EditorParametersRegistry param) {
            WindowObjectRegistry.Add(this, param);
        }

        private void ValidateRegistry(DirtyHelper dirtyHelper) {
            ref var registry = ref WindowObjectRegistry.GetRegistry(this);
