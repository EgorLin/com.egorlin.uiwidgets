...
namespace EgorLin.UIWidgets.Core {
    ...
    public class ComponentsDebugLog : ScriptableObject {
        ...
        public static void Add(WindowObject windowObject, ObjectState state) {
            ...
            if (isDebug == true) {
                var obj = UnityEditor.AssetDatabase.LoadAssetAtPath<ComponentsDebugLog>(EDITOR_COMPONENTS_DEBUG_PATH);
                if (obj == null) {
                    var instance = ScriptableObject.CreateInstance<ComponentsDebugLog>();
                    ...
                    obj = UnityEditor.AssetDatabase.LoadAssetAtPath<ComponentsDebugLog>(EDITOR_COMPONENTS_DEBUG_PATH);
                }
