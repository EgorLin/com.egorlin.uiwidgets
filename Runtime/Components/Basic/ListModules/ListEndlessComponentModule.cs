...
namespace EgorLin.UIWidgets.Components.Basic.ListModules {
    ...
    public class ListEndlessComponentModule : ListComponentModule {
        ...
        public class Registry<T, TClosure> : RegistryBase where T : WindowComponent where TClosure : IListClosureParameters {
        ...
        private Registry<T, TClosure> GetRegistry<T, TClosure>() where T : WindowComponent where TClosure : IListClosureParameters {
