...
namespace EgorLin.UIWidgets.Components.Base {
    ...
    public class WindowComponent : WindowObject, IHasPreview {
        ...
        public struct ComponentModules {
            ...
            [SearchComponentsByTypePopup(typeof(WindowComponentModule), "Window Component Module", allowClassOverrides: true, singleOnly: false)]
