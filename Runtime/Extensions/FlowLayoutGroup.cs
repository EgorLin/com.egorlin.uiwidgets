...
namespace EgorLin.UIWidgets.Extensions
{
    ...
    public class FlowLayoutGroup : LayoutGroup {
		...
		/// </summary>
		private readonly System.Collections.Generic.IList<RectTransform> _rowList = new System.Collections.Generic.List<RectTransform>(); 
		...
		protected void LayoutRow(System.Collections.Generic.IList<RectTransform> contents, float rowWidth, float rowHeight, float maxWidth, float xOffset, float yOffset, int axis) {
			var xPos = xOffset;
