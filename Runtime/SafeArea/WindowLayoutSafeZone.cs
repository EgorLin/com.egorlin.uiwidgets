...
namespace EgorLin.UIWidgets.SafeArea {
    ...
    public class WindowLayoutSafeZone : WindowComponent, ILateUpdate {
        ...
        public struct ScreenCache {
            ...
            public bool HasChanged {
                get {
                    if (this.deviceName != UnityEngine.Device.SystemInfo.deviceName) return false;
            ...
            public void Update() {
                ...
                this.deviceName = UnityEngine.Device.SystemInfo.deviceName;
            }
