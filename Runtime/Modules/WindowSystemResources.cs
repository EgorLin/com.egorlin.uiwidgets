...
namespace EgorLin.UIWidgets.Modules
{
    ...
    public interface ICustomLoader {
        ...
        public Awaitable<T> Load<T>(WindowSystemResources.LoadParameters loadParameters, Resource resource) where T : UnityEngine.Object;
#else
    ...
    public struct Resource : System.IEquatable<Resource> {
        ...
        public static Resource Create<TObject>(string address) {
            return new Resource() {
                address = address,
                objectType = WindowSystemResources.GetObjectType<TObject>(),
