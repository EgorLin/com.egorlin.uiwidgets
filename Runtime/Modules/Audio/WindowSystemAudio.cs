...
namespace EgorLin.UIWidgets.Modules.Audio {
    ...
    public class WindowSystemAudio : WindowSystemModule {
        ...
        public struct InteractableType {
            ...
            [SearchComponentsByTypePopup(typeof(IInteractable), menuName: "Type", singleOnly: true)]
        ...
        private ITapticEngine taptic;

        public override void OnStart() {

            Instance = this;
            
            this.taptic = new TapticEngine(this.tapticLogs);
            this.taptic.SetActiveModule(new TapticAnimationCurveImpl());
        ...
        private void OnAnyInteractable(IInteractable obj) {
