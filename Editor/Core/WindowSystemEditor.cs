...
using EgorLin.UIWidgets.Editor.Drawers;
using EgorLin.UIWidgets.Editor.UnityEditor;
...
namespace EgorLin.UIWidgets.Editor.Core {
    ...
    public class WindowSystemEditor : global::UnityEditor.Editor {
        ...
        public void UpdateProperties() {
            ...
            this.textureUtils = typeof(global::UnityEditor.Editor).Assembly.GetType("UnityEditor.TextureUtil");
                    ...
                    onDraw = () => {
                            ...
                            try {
                                ...
                                for (int i = 0; i < this.registeredPrefabs.arraySize; ++i) {
                                    ...
                                    if (window != null) {
                                        ...
                                        global::UnityEditor.AddressableAssets.Settings.AddressableAssetSettings aaSettings = global::UnityEditor.AddressableAssets.AddressableAssetSettingsDefaultObject.Settings;
                                        var groupPath = $"{mainDir}/{name}.asset";
                                        global::UnityEditor.AddressableAssets.Settings.AddressableAssetGroup group;
                                        if (System.IO.File.Exists(groupPath) == false) {
                                            
                                            group = aaSettings.CreateGroup(name, false, false, true, null);
                                            var scheme = group.AddSchema<global::UnityEditor.AddressableAssets.Settings.GroupSchemas.BundledAssetGroupSchema>();
                                        ...
                                        group = AssetDatabase.LoadAssetAtPath<global::UnityEditor.AddressableAssets.Settings.AddressableAssetGroup>(groupPath);
                        ...
                        if (GUILayout.Button("Find Direct References", GUILayout.Width(200f), GUILayout.Height(30f)) == true) {
                            ...
                            try {
                                ...
                                global::UnityEditor.U2D.SpriteAtlasUtility.PackAllAtlases(EditorUserBuildSettings.activeBuildTarget);
        ...
        public static List<string> GetRefLock(Object obj) {
            ...
            ValidateRefLock();
            var refLocks = AssetDatabase.LoadAssetAtPath<EditorRefLocks>(EDITOR_REF_LOCKS_PATH);
        ...
        public static void ValidateRefLock() {
            ...
            var refLocks = AssetDatabase.LoadAssetAtPath<EditorRefLocks>(EDITOR_REF_LOCKS_PATH);
            if (refLocks == null) {
                var instance = ScriptableObject.CreateInstance<EditorRefLocks>();
                instance.items = System.Array.Empty<EditorRefLocks.Item>();
