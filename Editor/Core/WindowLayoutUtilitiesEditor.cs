...
namespace EgorLin.UIWidgets.Editor.Core {
    public class WindowLayoutUtilities {
        ...
        public static void DrawLayout(int selectedIndexAspect, int selectedIndexInner, int selectedType, System.Action<int, int, int> onSet, ref Vector2 tabsScrollPosition, WindowLayout windowLayout, Rect r, LayoutWindowType drawComponents) {
        ...
        public static bool DrawLayout(float aspect, WindowLayout windowLayout, Rect r, float offset = 20f, HashSet<WindowLayout> used = null, DeviceInfo.ScreenData screenData = default, DeviceInfo.OrientationData orientationData = default, LayoutWindowType drawComponents = null) {
