...
namespace EgorLin.UIWidgets.Editor.Core {
    ...
    public class WindowSystemWindowBaseEditor : global::UnityEditor.Editor {
        ...
        public override bool HasPreviewGUI() {
            ...
            if (this.target is LayoutWindowType) {
        ...
        public override void OnInteractivePreviewGUI(Rect r, GUIStyle background) {
            ...
            if (this.target is LayoutWindowType layoutWindowType) {
        ...
        public override void OnInspectorGUI() {
            ...
            GUILayoutExt.DrawFieldsBeneath(this.serializedObject, typeof(LayoutWindowType));
