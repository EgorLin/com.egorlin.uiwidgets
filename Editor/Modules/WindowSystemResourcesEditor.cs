...
namespace EgorLin.UIWidgets.Editor.Modules {
    ...
    public class WindowSystemResourcesEditor : global::UnityEditor.Editor {
                    ...
                    onDraw = () => {
                        ...
                        if (loadedBundles.Count == 0) {
                            ...
                            if (
                                ...
                                #endif
                                global::UnityEditor.AddressableAssets.AddressableAssetSettingsDefaultObject.Settings.ActivePlayModeDataBuilder is global::UnityEditor.AddressableAssets.Build
