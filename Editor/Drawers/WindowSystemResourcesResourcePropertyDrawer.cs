...
using EgorLin.UIWidgets.Editor.Core;
...
namespace EgorLin.UIWidgets.Editor.Drawers {
    ...
    public class WindowSystemResourcesResourceGenericPropertyDrawer : PropertyDrawer {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label) {
            ...
            WindowSystemResourcesResourcePropertyDrawer.DrawGUI(position, ref this.prevSelected, res, label, type, RequiredType.None);
    ...
    public class WindowSystemResourcesResourcePropertyDrawer : PropertyDrawer {
        ...
        public static System.Type GetTypeByAttr(System.Reflection.FieldInfo field, out RequiredType requiredType) {
        ...
        public static Result DrawGUI(SerializedProperty property, ref ObjDrawerCache prevSelected, Rect position, GUIContent label, Resource value, bool hasMultipleDifferentValues, System.Type type = null, RequiredType requiredType = RequiredType.None) {
        ...
        public static void DrawGUI(Rect position, ref ObjDrawerCache prevSelected, SerializedProperty property, GUIContent label, System.Type type, RequiredType requiredType) {
        ...
        public static void Validate(ref Resource resource, System.Type type = null) {
            ...
            if (newObj == null) {
                ...
                var entry = global::UnityEditor.AddressableAssets.AddressableAssetSettingsDefaultObject.Settings.FindAssetEntry(resource.guid, includeImplicit: true);
                if (entry != null) {
