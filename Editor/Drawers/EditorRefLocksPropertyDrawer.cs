    ...
    public static class EditorRefLocksPropertyDrawer {
        ...
        public static void Draw(SerializedObject serializedObject, string guid = null) {
            ...
            if (editorRefLocksList == null || EditorRefLocksPropertyDrawer.serializedObject != serializedObject || EditorRefLocksPropertyDrawer.lastGuid != guid) {
                ...
                var componentsProp = WindowSystemEditor.GetRefLockProperty(guid != null ? guid : global::UnityEditor.AssetDatabase.AssetPathToGUID(global::UnityEditor.AssetDatabase.GetAssetPath(component)));
