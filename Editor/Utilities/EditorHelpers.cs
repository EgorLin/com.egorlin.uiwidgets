...
namespace EgorLin.UIWidgets.Editor.Utilities {
    ...
    public static class EditorHelpers {
...

            {
                ...
                foreach (var img in images) {
                    ...
                    if (img.obj is Sprite sprite) {
                        ...
                        tex = global::UnityEditor.Sprites.SpriteUtility.GetSpriteTexture(sprite, false);
                    ...
                    if (windowLayoutType != null) {
                        ...
                        { // Validate components list
                            ...
                            for (int c = 0; c < layoutItem.components.Length; ++c) {
                                ...
                                WindowSystemResourcesResourcePropertyDrawer.Validate(ref com.component, typeof(WindowComponent));
        ...
        public static WindowLayoutSafeZone AddSafeZone(Transform root) {
            ...
            return safeGo.GetComponent<WindowLayoutSafeZone>();
