...
namespace EgorLin.UIWidgets.Editor.UnityEditor
{
    public static class AddressableEditorExtension {
        ...
        public static void SetAddressableID(this GameObject gameObject, string id, global::UnityEditor.AddressableAssets.Settings.AddressableAssetGroup group = null) {
        ...
        /// <param name="id">Key/ID</param>
        public static void SetAddressableID(this Object o, string id, global::UnityEditor.AddressableAssets.Settings.AddressableAssetGroup group = null) {
            if (id.Length == 0) {
        ...
        public static global::UnityEditor.AddressableAssets.Settings.AddressableAssetEntry GetAddressableAssetEntry(Object o, bool createNew = true,
            global::UnityEditor.AddressableAssets.Settings.AddressableAssetGroup group = null) {
            var aaSettings = global::UnityEditor.AddressableAssets.AddressableAssetSettingsDefaultObject.Settings;

            global::UnityEditor.AddressableAssets.Settings.AddressableAssetEntry entry = null;
